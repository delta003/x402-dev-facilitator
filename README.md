...
Run x402 facilitator on a custom network. Built to be used with Tenderly's virtual networks.

To run facilitator use `go run main.go` and set the environment variables in `.env` file.
...
NOTE: This was built to understand x402. Do not use any of it in production.
